...
const WwwcToolDialog = ({ open, onClose }) => {
  const { activateWwwcTool, imageInfos } = useContext(ToolManageService);
...
export const WwwcTool = () => {
  ...
  return (
    <>
      <WwwcToolDialog open={open} onClose={() => setOpen(false)} />
